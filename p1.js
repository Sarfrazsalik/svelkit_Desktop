...
//  const signUpResponse = await authModule.signUp({ email: "rsalik2001@gmail.com", password: "salik@123" });
...
//     outputs: [
//       {
//         address: 'rsalik2001@dev.neucron.io',
//         note: 'just aise hi',
//         amount: 10
//       }
//     ]
...
console.log(walletHistory);
 ...
 const walletCreation1 = await walletModule.createWallet({ walletName: 'Md Salik' });
